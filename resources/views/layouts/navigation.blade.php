<aside class="w-64 flex-shrink-0 bg-white border-r border-gray-200 flex flex-col justify-between z-20 overflow-y-auto dark:bg-gray-800 dark:border-gray-700">
    <div class="py-4">
        ...
        <nav class="px-3 space-y-1">
            <p class="px-3 text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">{{ __('Planning') }}</p>
            ...
            <div class="pt-8">
                <p class="px-3 text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">{{ __('Settings') }}</p>
                <!-- Dark Mode Toggle -->
