<x-app-layout>
    ...
    <div class="mb-8 max-w-4xl">
        <p class="text-gray-600 text-base leading-relaxed">{{ $project->description ?: __('No description provided for this project.') }}</p>
    </div>

    <!-- Kanban Board -->
    <div class="flex items-center justify-between mb-6">
        <h3 class="text-xl font-semibold text-[#172B4D]">{{ __('Board') }}</h3>
